**Que es:** Conection bidireccional entre el cliente and the server
**handshake (apreton de manos):** convierte una petición http tradicional a una conexión bidireccional y persistente.
